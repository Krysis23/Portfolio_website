...
/** Simple fade in with no vertical movement */
...
/** Stagger children animations — use on a parent container */
...
/** Stagger container with faster timing for grids */
